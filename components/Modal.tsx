...
useEffect(()=>{
  ...
  useEffect(
    ...
    [movies]
                ...
                const handleList=async()=>{
                  ...
                  setDoc(doc(db,"custumers",user!.uid ,"myList",movie?.id.toString()!),
                  {...movie})
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className='fixes !top-7 left-0 right-0 z-50 mx-auto  w-full  max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide'>
                <>
                <Toaster />
                <button onClick={handleClose} className="modalButton absolute right-4 top-5 !z-40 h-9 w-9 border-none bg-[#181818] "><XIcon className='h-6 w-6'/></button>
